...
<section class="slider">
        <div class="container">
            <div id="owl-demo" class="owl-carousel owl-theme">
                ...
                <div class="item">
                    <div class="slide">
                        <img src="image<section class="slider">
        <div class="container">
            <div id="owl-demo" class="owl-carousel owl-theme">
                <div class="item">
                    <div class="slide">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        <img src=<?php echo "../uploadImage/".$info['photo']; ?> alt="img">
                        <h3><?php echo $info['title']; ?></h3>
                        <h6><span class="price"><?php echo "Rs. ". $info['price']; ?></span> / <a href="AddToCart.php?ref=<?php echo $info['id'];?>">Add To Cart</a></h6>
                        <div class="hover">
            ...
            <div class="row">
               <?php
                ...
                <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="item">
                         <img src=<?php echo "../uploadImage/".$info['photo']; ?> alt="img">
                        <h3><a href="#"><?php echo $info['title']; ?></a></h3>
                        <h6><span class="price"><?php echo "Rs. ". $info['price']; ?></span> / <a href="AddToCart.php?ref=<?php echo $info['id'];?>">Add To Cart</a></h6>
                    </div>
                </div>
                <?php 
