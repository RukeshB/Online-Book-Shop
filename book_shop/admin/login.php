<?php 
  ...
  if(isset($_POST['loginBtn']))
  {
    ...
    if( $loged->getLoginDetail('admin',$_POST))
    {
        redirection('dashboard.php');
      //header('location: dashboard.php');
    }
...
<html>
    ...
    <body >
        ...
        <div class="account-pages" style="background:url('assets/images/bg-01-dark.jpg') no-repeat center center fixed;  background-size: cover;"></div>
        <div class="clearfix"></div>
        <div class="wrapper-page">
        	<div class=" card-box">
            <div class="panel-heading"> 
                <h3 class="text-center"> Sign In to <strong class="text-custom">Book Store</strong> </h3>
            </div> 
